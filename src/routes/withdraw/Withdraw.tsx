      ...
      <h6>Please enter your SSN to confirm the withdraw</h6>
            <div className="form-group col-md-4 ">
                ...
                <div>
                    ...
                    <div>Thank you for banking with us! What would you like to do next?</div>
                    <button type="submit" className="btn btn-secondary"> <div onClick={goToLogin}>Continue Banking</div></button>
                    <div>

                    </div>
                    <br></br>
                    <button type="submit" className="btn btn-secondary"> <div onClick={LeaveBank}>Exit ATM</div></button>
                    </div>
                </div>
            </div>
      </form>
